...
export default {
  ...
  methods: {
    ...
    getRunnerList(){
      usermanagement.getRunnerUsers().then((response)=>{
    ...
    getPoolList(){
      pools.getAllPools().then((response)=>{
    ...
    getBotList(){
      repository.getAllPublicBots().then((response)=>{
